...
const RO: Dict = {
  ...
  "contact.sent": "Mesajul a fost trimis. Îți mulțumim!",
  "contact.error": "Mesajul nu a putut fi trimis. Încearcă din nou.",
  "contact.followTitle": "Urmărește-ne",
  "contact.followLead": "Abonează-te la noutăți prin email sau urmărește pagina noastră de Facebook.",
  "contact.subscribe": "Abonare la noutăți prin email",
...
const EN: Dict = {
  ...
  "nav.news": "News",
  "nav.contact": "Contact",
  "nav.archiveLink": "Archive",

  "about.title": "About ATOM Ploiești",
  "about.lead": "The “ATOM” Ploiești Cultural Society — founded in 2018 to preserve and share the urban history of Ploiești.",
  "about.joinBtn": "Membership application",

  "projects.title": "Projects and publications",
  "projects.lead": "Books published by the ATOM Ploiești Cultural Society, dedicated to the history and heritage of the city.",
  "projects.featured": "Featured project",
  "projects.volumes": "Published volumes",
  "projects.source": "View on atomploiesti.ro",
  "projects.author": "Author",

  "news.title": "News",
  "news.lead": "Recent news about the association's activities and the heritage life of Ploiești.",
  ...
  "contact.facebook": "Facebook",
  "contact.site": "Official website",
  "contact.support": "Support us: 3.5% of your income tax",
  "contact.form230": "Form 230 (income from wages)",
  "contact.declaration": "Single Tax Return (other income)",
  ...
  "contact.followLead": "Subscribe to our updates by email or follow our Facebook page.",
  "contact.subscribe": "Subscribe to updates by email",
...
const FR: Dict = {
  ...
  "about.title": "À propos d'ATOM Ploiești",
  "about.lead": "Société Culturelle « ATOM » Ploiești — fondée en 2018 pour préserver et faire connaître l'histoire urbaine de Ploiești.",
  "about.joinBtn": "Demande d'adhésion",

  "projects.title": "Projets et publications",
  "projects.lead": "Ouvrages publiés par la Société Culturelle ATOM Ploiești, consacrés à l'histoire et au patrimoine de la ville.",
  "projects.featured": "Projet en vedette",
  "projects.volumes": "Volumes publiés",
  "projects.source": "Voir sur atomploiesti.ro",
  "projects.author": "Auteur",

  "news.title": "Actualités",
  "news.lead": "Nouvelles récentes des activités de l'association et de la vie du patrimoine de Ploiești.",
  ...
  "contact.phones": "Téléphone",
  "contact.fax": "Fax",
  "contact.emailAddr": "E-mail",
  ...
  "contact.facebook": "Facebook",
  "contact.site": "Site officiel",
  "contact.support": "Soutenez-nous : 3,5 % de l'impôt sur le revenu",
  "contact.form230": "Formulaire 230 (revenus salariaux)",
  "contact.declaration": "Déclaration Unique (autres revenus)",
  ...
  "contact.error": "Le message n'a pas pu être envoyé. Veuillez réessayer.",
  "contact.followTitle": "Suivez-nous",
  "contact.followLead": "Abonnez-vous à nos actualités par e-mail ou suivez notre page Facebook.",
  "contact.subscribe": "S'abonner aux actualités par e-mail",
  ...
  "admin.unauthorized.desc": "Votre compte est connecté mais n'a pas de droits d'administrateur. S'il s'agit d'une nouvelle installation, revendiquez la première place ci-dessous.",
  "admin.claim": "Revendiquer le premier admin",
  "admin.claim.exists": "Un administrateur existe déjà. Contactez le propriétaire du site.",
  "admin.claim.failed": "Échec",
