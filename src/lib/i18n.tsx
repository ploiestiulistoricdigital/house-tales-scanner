...
const RO: Dict = {
  ...
  "err.name.max": "Numele este prea lung (max. 150 caractere).",
  "err.slug.required": "Identificatorul URL este obligatoriu.",
  "err.slug.min": "Identificatorul URL trebuie să aibă cel puțin 2 caractere.",
  "err.slug.max": "Identificatorul URL este prea lung (max. 100 caractere).",
  "err.slug.format": "Folosește doar litere mici, cifre și cratime (fără spații sau diacritice). Ex: casa-batllo",
  ...
  "qr.pdfTitle": "Scanează pentru poveste",
...
const EN: Dict = {
  ...
  "err.name.max": "Name is too long (max 150 characters).",
  "err.slug.required": "URL identifier is required.",
  "err.slug.min": "URL identifier must be at least 2 characters.",
  "err.slug.max": "URL identifier is too long (max 100 characters).",
  "err.slug.format": "Use only lowercase letters, digits and dashes (no spaces or diacritics). E.g. casa-batllo",
  ...
  "qr.pdfTitle": "Scan for the story",
