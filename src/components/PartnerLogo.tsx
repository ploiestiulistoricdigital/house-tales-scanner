...
export function PartnerLogo({ name, src, href, className = "" }: PartnerLogoProps) {
  const logoBox = (
    <div className="flex h-16 w-32 sm:h-20 sm:w-40 items-center justify-center rounded-sm border border-border/70 bg-transparent p-3 transition-transform duration-200 ease-out group-hover:scale-105 group-hover:border-primary/60">
